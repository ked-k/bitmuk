...
(function () {
  ...
  var objectKeysInternal = function objectKeysInternal(object, names) {
    ...
    for (key in O) {
      !hasOwnProperty_1(hiddenKeys, key) && hasOwnProperty_1(O, key) && result.push(key);
  ...
  */
  ...
  var domTokenListPrototype = DOMTokenListPrototype === Object.prototype ? undefined : DOMTokenListPrototype; // optional / simple context binding
  ...
  handlePrototype(domTokenListPrototype); // `Object.prototype.toString` method implementation
  ...
  var FORCED = isForced_1(PROMISE, function () {
    ...
    if (isPure && !PromiseConstructorPrototype['finally']) return true; // We can't use @@species feature detection in V8 since it causes
  ...
  var defineWellKnownSymbol = function defineWellKnownSymbol(NAME) {
    ...
    if (!hasOwnProperty_1(_Symbol, NAME)) defineProperty$2(_Symbol, NAME, {
  ...
  var handlePrototype$1 = function handlePrototype$1(CollectionPrototype, COLLECTION_NAME) {
  ...
  handlePrototype$1(domTokenListPrototype, 'DOMTokenList'); // `RegExp.prototype.flags` getter implementation
  ...
  var Chocolat = /*#__PURE__*/function () {
    ...
    _createClass(Chocolat, [{
      ...
      value: function off(element, eventName) {
        var _this14 = this; // const eventName = this.settings.setIndex + '-' + eventName
