                ...
                <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="smtp.googlemail.com"
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="465"
                        ...
                        <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_encryption" id="mail_encryption" value="ssl"
                        ...
                        <div class="form-group {{ $errors->has('mail_from_address') ? ' has-error ' : '' }}">
                            <label
                                for="mail_from_address">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_from_address') }}</label>
                            <input type="text" name="mail_from_address" id="mail_from_address"
                                   placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_from_address') }}"/>
